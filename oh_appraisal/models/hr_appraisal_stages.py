...
class HrAppraisalStages(models.Model):
    ...
    name = fields.Char(help="Name of the appraisal stage")
    sequence = fields.Integer(help="Sequence of the appraisal stage to be " "shown")
    fold = fields.Boolean(
        string="Folded in Appraisal Pipeline",
